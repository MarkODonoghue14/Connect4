...
//		int x =0 ,y =0;
//		while(y != COLUMNS){
//			if(winAt(board, x, y, 1, 1) != NONE)
//				return winAt(board, x, y, 1, 1);
//			if(winAt(board, x, y, 0, 1) != NONE)
//				return winAt(board, x, y, 0, 1);
//			if(winAt(board, x, y, 1, 0) != NONE)
//				return winAt(board, x, y, 1, 0);
//			if(winAt(board, x, y, 1, -1) != NONE)
//				return winAt(board, x, y, 1, -1);
//			x++;
//			if(x==ROWS){
...
//					drop(board, COMPUTER, c);
//					// Calls min, in a similiar manner to how min called max.
